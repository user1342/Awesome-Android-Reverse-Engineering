...
- [Android Studio](https://developer.android.com/studio) - Useful if you don’t have a JEB license and want to open a decompiled (via JADx) app into a proper IDE.
...
- [FriDump](https://github.com/Nightbringer21/fridump) - A Python script that utilizes Frida to dump the memory of a running gadget, such as an app activity.
...
- [JDGui](htt p://java-decompiler.github.io/) - JD-GUI is a standalone graphical utility that displays Java source codes of “.class” files.
...
- [KGB Messenger](https://github.com/tlamb96/kgb_messenger) - KGB Messenger is a open source CTF practice challenge that aims to help people learn how to reverse engineer Android applications.
